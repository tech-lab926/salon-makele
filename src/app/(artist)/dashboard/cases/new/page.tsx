...
export default function NewCasePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([catData, menuData, profileData]) => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900">新規症例追加</h1>
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="施術の詳細、お客様の要望、仕上がりについて記載してください（300〜500文字）"
            className={`mt-1.5 ${inputClass}`}
          />
          <p className="mt-1 text-xs text-gray-400">
            {form.description.length}文字
          </p>
        </div>
